...
class Tweet extends User{
			          ...
			          <div class="t-show-img">
			        	...
			        	<div class="t-s-head-content">
			        		<div class="t-h-c-name">
			        			<span><a href="'.BASE_URL.'profile_page.php?username='.$user->username.'">'.$user->screenName.'</a></span>
			      		...
			      		<div class="t-show-head">
			      			...
			      			<div class="t-s-head-content ">
			      				<div class="t-h-c-name media-body">
			      					<span><a href="profile_page.php?username='.$tweet->username.'">'.$tweet->screenName.'</a></span>
			      					<span>@'.$tweet->username.'</span>
			      					<span>'.$this->timeAgo($tweet->postedOn).'</span>
			      				</div>
			      				<div class="t-h-c-dis">
	...
	public function getTweetLinks($tweet){
		...
		$tweet = preg_replace("/#([\w]+)/", "<a href='http://localhost/twitter/hashtag.php?hashtag=$1'>$0</a>", $tweet);	
        
		$tweet = preg_replace("/@([\w]+)/", "<a href='http://localhost/twitter/profile.php?username=$1'>$0</a>", $tweet);
		return $tweet;		
	}
